...
public class MonsterTwo {
	...
	/*
	 * The Constructor Code that is executed when an object is created from this
	 * class definition The method name is the same as the class The constructor
	 * is only executed once per object The constructor can't return a value
	 */
	...
	public MonsterTwo(int health, int attack, int movement, String name) {
		...
		this.name = name;
		/*
		 * If the attributes had the same names as the class health, attack,
		 * movement You could refer to the objects fields by proceeding them
		 * with this this.health = health; this.attack = attack; objectFieldName
		 * = attributeFieldName;
		 */
	...
	// The following constructor is the one provided by default if you don't
	// create any other constructors
	// Default Constructor
